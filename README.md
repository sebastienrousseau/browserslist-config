...
<p align="center">
  Shareable Browserslist target configuration rules
</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/browserslist-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fbrowserslist-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/browserslist-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14505"><img src="https://img.shields.io/cii/level/14505?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Modern Browser Target Selection](#modern-browser-target-selection) — before and after rule comparison
...
Install `@sebastienrousseau/browserslist-config` as a development dependency:
...
Browserslist extends a shareable query list by package name.
...
`@sebastienrousseau/browserslist-config` solves this with three deliberate engineering choices:
...
When your application explicitly targets legacy runtimes (such as Internet Explorer 11) or proprietary embedded legacy webviews.
