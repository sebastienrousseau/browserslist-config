...
%global npm_bare      browserslist-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-browserslist-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Browserslist target configuration rules

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/browserslist-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/browserslist-config is a shareable configuration preset with no runtime
