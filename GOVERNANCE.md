...
This document describes how @sebastienrousseau/browserslist-config is run: who decides what, how
...
@sebastienrousseau/browserslist-config is **maintainer-led**. As of the current release line it has a single
