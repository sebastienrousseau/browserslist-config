...
# Packaging @sebastienrousseau/browserslist-config
...
Peer dependency: `browserslist >=4.0.0`.
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/browserslist-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/browserslist-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/browserslist-config/` |
| Homebrew | [`pkg/brew/browserslist-config.rb`](../pkg/brew/browserslist-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/browserslist-config/` |
